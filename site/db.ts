...
export const siteMap = [{
    ...
    alias: "B08",
    about: "This RV site is centrally located in section B away from the brook and across foot-bridge from the bathhouse.",
    power: true,
    water: true,
    sewer: true,
}, {
    ...
    alias: "B10",
    about: "This RV site is relatively quiet, located near the back of section B, away from the brook and across the foot-bridge from the bathhouse.",
    power: true,
    water: true,
    sewer: true,
}, {
    alias: "B11",
    about: "This RV site is located in the back of section B, away from the brook and across the foot-bridge from the bathhouse.",
    power: true,
    water: true,
    sewer: true,
}, {
    alias: "B12",
    about: "This RV site is located near the back of section B, on the brook and across the foot-bridge from the bathhouse.",
    power: true,
    water: true,
    sewer: true,
}, {
    ...
    alias: "B16",
    about: "Centrally located in section B, just across the foot-bridge from the bathhouse.",
    power: true,
    water: true,
    sewer: true,
}, {
    alias: "C14",
    about: "This tent site is near a playful section of the brook with some privacy and shade.",
    power: true,
    water: true,
    sewer: false,
}, {
    alias: "C15",
    about: "This tent site shares access with site C17 and has easy access to the brook.",
    power: true,
    water: true,
    sewer: false,
}, {
    ...
    alias: "C18",
    about: "This spacious tent site is suitable for a small RV or camper and is close to the restrooms but a decent walk for a shower.",
    power: true,
    water: true,
    sewer: false,
}, {
    alias: "C19",
    about: "This secluded tent site has access to beautiful views of the brook, amazing forest experience, moderate privacy and still close to the restrooms.",
    power: true,
    water: true,
    sewer: false,
}, {
